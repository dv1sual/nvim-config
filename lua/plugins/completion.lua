-- lua/plugins/completion.lua - Auto-completion with nvim-cmp
...
return {
  ...
  -- Snippets
  {
    "L3MON4D3/LuaSnip",
    build = (function()
      -- Build step that works on both Windows and Unix systems
      if vim.fn.has("win32") == 1 then
        return nil -- Skip the build step on Windows
      else
